...
<title>借款审批系统--借款单对应发票类型配置</title>
...
<body>
					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h5 class="font14 fltl">借款单对应发票类型列表</h5>
								<div class="textRight cor333">
									<a href="/loanSys/loanToInvoice_new.do"
								...
								<div class="table-responsive">
									<table class="table table-bordered hovers thin">
                                    	...
                                    	<tr class="data">
                                    		...
                                    		<td onClick="javascript:window.location.href='loanToInvoice_new.do?id={{id}}';">{{id}}</td>
                                    		<td onClick="javascript:window.location.href='loanToInvoice_new.do?id={{id}}';">{{loanType}}</td>
                                    		<td onClick="javascript:window.location.href='loanToInvoice_new.do?id={{id}}';">{{accounting}}</td>
											<td onClick="javascript:window.location.href='loanToInvoice_new.do?id={{id}}';">{{createBy}}</td>
                                    		<td onClick="javascript:window.location.href='loanToInvoice_new.do?id={{id}}';">{{createDate}}</td>
											<td onClick="javascript:window.location.href='loanToInvoice_new.do?id={{id}}';">{{lastupdateBy}}</td>
                                    		<td onClick="javascript:window.location.href='loanToInvoice_new.do?id={{id}}';">{{lastupdateDate}}</td>
                                    	</tr>
                                		</script>
	...
	<script src="local-js/loanToInvoice.js"></script>
</body>
</html>