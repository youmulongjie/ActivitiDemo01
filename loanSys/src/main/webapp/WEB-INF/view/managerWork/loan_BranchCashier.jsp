					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h5 class="font14 fltl">分公司出纳配置列表</h5>
								<div class="textRight cor333">
									<a href="/loanSys/loan_BranchCashier_new.do"
								...
								<div class="table-responsive">
									<table class="table table-bordered hovers thin">
                                    	...
                                    	<tr class="data">
                                    		...
                                    		<td onClick="javascript:window.location.href='loan_BranchCashier_new.do?id={{id}}';">{{id}}</td>
                                    		<td onClick="javascript:window.location.href='loan_BranchCashier_new.do?id={{id}}';">{{branch}}</td>
                                    		<td onClick="javascript:window.location.href='loan_BranchCashier_new.do?id={{id}}';">{{cashier}}</td>
											<td onClick="javascript:window.location.href='loan_BranchCashier_new.do?id={{id}}';">{{createBy}}</td>
                                    		<td onClick="javascript:window.location.href='loan_BranchCashier_new.do?id={{id}}';">{{createDate}}</td>
											<td onClick="javascript:window.location.href='loan_BranchCashier_new.do?id={{id}}';">{{lastupdateBy}}</td>
                                    		<td onClick="javascript:window.location.href='loan_BranchCashier_new.do?id={{id}}';">{{lastupdateDate}}</td>
                                    	</tr>
                                		</script>
