					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h5 class="font14 fltl">系统管理员配置列表</h5>
								<div class="textRight cor333">
									<a href="/loanSys/loan_sys_admin_new.do"
									...
									<table class="table table-bordered hovers thin">
										<thead class="textCenter">
											<tr>
												...
												<th class="text-nowrap">系统管理员名称</th>
                                    	...
                                    	<tr class="data">
                                    		...
                                    		<td onClick="javascript:window.location.href='loan_sys_admin_new.do?id={{id}}';">{{id}}</td>
                                    		<td onClick="javascript:window.location.href='loan_sys_admin_new.do?id={{id}}';">{{username}}</td>
											<td onClick="javascript:window.location.href='loan_sys_admin_new.do?id={{id}}';">{{createBy}}</td>
                                    		<td onClick="javascript:window.location.href='loan_sys_admin_new.do?id={{id}}';">{{createDate}}</td>
											<td onClick="javascript:window.location.href='loan_sys_admin_new.do?id={{id}}';">{{lastupdateBy}}</td>
                                    		<td onClick="javascript:window.location.href='loan_sys_admin_new.do?id={{id}}';">{{lastupdateDate}}</td>
                                    	</tr>
                                		</script>
