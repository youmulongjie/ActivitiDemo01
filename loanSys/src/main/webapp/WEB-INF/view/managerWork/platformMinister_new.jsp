							...
							<form id="saveForm">
								...
								<div class="panel-body">
									...
									<div class="form-group single row">
										<label class="col-sm-3 control-label textRight">平台部门名称：</label>
										<div class="col-md-3">
											<c:if test="${!empty entity}">
									...
									<div class="form-group single row">
										<label class="col-sm-3 control-label textRight">平台部长名称：</label>
										<div class="col-md-3">
											<c:if test="${!empty entity}">
												<input type="text" name="ministerName" id="ministerName"
													class="form-control input-sm pdl6 pdt4"
													value="${entity.ministerName}">
											</c:if>
											<c:if test="${empty entity }">
												<input type="text" name="ministerName" id="ministerName"
													class="form-control input-sm pdl6 pdt4">
